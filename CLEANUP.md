...
| `src/tools/shell.ts` | Stateless command/process execution and Workspace escape limitations | **SOURCE REVIEW COMPLETE**; process/work-boundary tests pending | **KEEP API/stateless design; targeted lifecycle and safety improvements candidate** |
