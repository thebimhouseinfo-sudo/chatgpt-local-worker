...
| `src/tools/filesystem.ts` | Actual operation consumers, mutation guarantees and residual inherited implementation | **SOURCE REVIEW COMPLETE**; grouped mutation/boundary tests pending | **KEEP tool API; targeted safety/patch integration improvements candidate** |
