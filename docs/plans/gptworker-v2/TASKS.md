...
| TASK-V2-009 | IN_PROGRESS | AppData custom Job routing + live trial | TASK-V2-012 | repo defaults + AppData custom Jobs merge; create enforces global unique id; update/remove custom-only; restart preserves custom Jobs | Routing implementation in current wave |
