...
2026-09-20: hoàn thành review và đề xuất plan; baseline build/validate/jobs/npm test PASS. Reproduced changed-binding confirmation bug. Runtime implementation, regression additions, Driver, AppData migration, authoring và packaging đều chưa bắt đầu. Live identity/wake evidence chưa có.
