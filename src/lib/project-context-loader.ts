...
const DEFAULT_MAX_BYTES = parseInt(process.env.PROJECT_CONTEXT_MAX_BYTES || "25000", 10);
const DEFAULT_MAX_LINES = parseInt(process.env.PROJECT_CONTEXT_MAX_LINES || "200", 10);
...
async function readTextLimited(
  ...
  maxBytes: number,
  maxLines: number,
  kind: ProjectContextSection["kind"]
