...
const requiredSkills = [
  "repository-discovery.md","planning.md","implementation.md","debugging.md","testing.md","validation.md",
...
result.coding = { skills: requiredSkills.length, harness_entrypoints: requiredHarness.length };
